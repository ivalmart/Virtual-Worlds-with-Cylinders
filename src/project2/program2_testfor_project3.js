...
pointLightSphere.setTranslate(lightDirection.elements[0], lightDirection.elements[1], lightDirection.elements[2]);
...
function pltTranslateX(value) {
    ...
    lightDirection.elements[0] = value / MAX_TRANSLATE;
    gl.uniform3fv(u_lightDirection, lightDirection.elements);
    pointLightSphere.setTranslate(lightDirection.elements[0], lightDirection.elements[1], lightDirection.elements[2]);
...
function pltTranslateY(value) {
    ...
    lightDirection.elements[1] = value / MAX_TRANSLATE;
    gl.uniform3fv(u_lightDirection, lightDirection.elements);
    pointLightSphere.setTranslate(lightDirection.elements[0], value / MAX_TRANSLATE, lightDirection.elements[2]);
...
function pltTranslateZ(value) {
    ...
    lightDirection.elements[2] = value / MAX_TRANSLATE;
    gl.uniform3fv(u_lightDirection, lightDirection.elements);
    pointLightSphere.setTranslate(lightDirection.elements[0], lightDirection.elements[1], value / MAX_TRANSLATE);    
